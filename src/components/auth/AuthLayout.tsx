...
// ── Media Query Hook ─────────────────────────────────────────────────────────
// Ensures {children} is only rendered ONCE in the DOM at any time,
// preventing react-hook-form ref conflicts between mobile/desktop instances.
...
export function AuthLayout({ children, title, subtitle, contentMaxWidth = "max-w-md", noScroll = false }: AuthLayoutProps) {
    ...
    return (
        <>
            ...
            {/* ========================================================================= */}
            {/* Conditionally render ONLY the correct layout so {children} exists once    */}
            {/* ========================================================================= */}
            {!isDesktop ? (
                /* ================================================================== */
                /* 1. MOBILE VIEW (< lg screens)                                      */
                /* ================================================================== */
                <div className="flex flex-col min-h-[100dvh] w-full bg-white dark:bg-[#0B0F1A] text-slate-900 dark:text-white font-sans relative overflow-y-auto selection:bg-blue-500/30">
                ...
                /* ================================================================== */
                /* 2. DESKTOP VIEW (lg: screens)                                       */
                /* ================================================================== */
                <div className="flex h-screen overflow-hidden w-full bg-gradient-to-b from-[#e0f2fe] via-[#93c5fd]/50 to-[#1e3a8a]/90 dark:from-[#0B0F1A] dark:via-[#0F172A] dark:to-[#020617] flex-col justify-between items-center p-4 lg:p-6 font-sans selection:bg-blue-500/30 transition-colors duration-300 relative">
