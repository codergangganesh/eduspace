    ...
    return (
        <footer className="bg-transparent dark:bg-slate-900/90 backdrop-blur-lg border-t border-white/10 dark:border-slate-800">
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="#features" className="text-sm text-slate-300 dark:text-slate-400 hover:text-blue-400 transition-colors">
                                    Features
                                </a>
                            </li>
                            <li>
                                <a href="#students" className="text-sm text-slate-300 dark:text-slate-400 hover:text-blue-400 transition-colors">
                                    For Students
                                </a>
                            </li>
                            <li>
                                <a href="#lecturers" className="text-sm text-slate-300 dark:text-slate-400 hover:text-blue-400 transition-colors">
                                    For Lecturers
                                </a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a href="#" className="text-sm text-slate-300 dark:text-slate-400 hover:text-blue-400 transition-colors">
                                    System Status
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-2 text-sm text-slate-300 dark:text-slate-400">
                                <Mail className="size-4 mt-0.5 flex-shrink-0 text-blue-400 dark:text-blue-400" aria-hidden="true" />
                                <a href="mailto:eduspacelearning8@gmail.com" className="hover:text-blue-400 transition-colors" aria-label="Email us at eduspacelearning8@gmail.com">
                                    eduspacelearning8@gmail.com
                                </a>
                            </li>
                            <li className="flex items-start gap-2 text-sm text-slate-300 dark:text-slate-400">
                                <Phone className="size-4 mt-0.5 flex-shrink-0 text-blue-400 dark:text-blue-400" aria-hidden="true" />
                                <a href="tel:+917670895485" className="hover:text-blue-400 transition-colors" aria-label="Call us at +91 7670895485">
                                    +91 7670895485
                                </a>
                            </li>
                            <li className="flex items-start gap-2 text-sm text-slate-300 dark:text-slate-400">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex items-center gap-3">
                                <a
                                    ...
                                    className="p-2 rounded-lg bg-white/10 dark:bg-slate-800 text-slate-200 dark:text-slate-400 hover:bg-blue-600 hover:text-white transition-colors"
                ...
                {/* Bottom Bar */}
                <div className="pt-8 border-t border-white/10 dark:border-slate-800">
