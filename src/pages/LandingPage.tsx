...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex items-center gap-6">
                            ...
                            <a href="#students" className="text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
                                For Students
                            </a>
                            <a href="#lecturers" className="text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
                                For Lecturers
                            </a>
                            <button
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 p-8 space-y-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-sm text-slate-500 dark:text-slate-400">Semester Progress</h3>
                                        <div className="flex items-baseline gap-2">
                                            <span className="text-2xl font-bold text-slate-900 dark:text-white">Week 8</span>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl">
                                    ...
                                    <div className="text-3xl font-bold text-slate-900 dark:text-white">3.8</div>
                                ...
                                <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-xl">
                                    ...
                                    <div className="text-xs text-slate-500 dark:text-slate-400">Assignment Rate</div>
                                </div>
                            </div>
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                                        <div>
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-sm font-medium text-slate-900 dark:text-white">Computer Science 101</span>
                                            </div>
                                            <span className="text-xs text-slate-500 dark:text-slate-400">Midterm Exam</span>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                                        <div>
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-sm font-medium text-slate-900 dark:text-white">Calculus II</span>
                                            </div>
                                            <span className="text-xs text-slate-500 dark:text-slate-400">Problem Set 4</span>
                                        </div>
                            ...
                            <div className="flex items-center gap-2 text-sm">
                                ...
                                <span className="text-slate-500 dark:text-slate-400">improvement this semester</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Features Section */}
            <section id="features" className="py-20 lg:py-32 bg-slate-100 dark:bg-slate-900/50">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all hover:-translate-y-1"
                            >
            ...
            <section id="students" className="py-20 lg:py-32">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative">
                            <div className="bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/20 dark:to-blue-900/20 rounded-3xl p-12 space-y-6">
                                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg">
                                    <div className="flex items-center gap-3 mb-4">
                                        <Star className="size-6 text-yellow-500" />
                                        <div>
                                            <div className="font-bold text-slate-900 dark:text-white">4.2 GPA</div>
                                ...
                                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg">
                                    <div className="flex items-center justify-between mb-3">
                                        <span className="text-sm font-medium text-slate-900 dark:text-white">Upcoming Deadlines</span>
                                        <Clock className="size-4 text-blue-600 dark:text-blue-400" />
                                    </div>
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between text-sm">
                                            <span className="text-slate-600 dark:text-slate-400">Physics Lab Report</span>
                                            <span className="text-orange-600 dark:text-orange-400 font-medium">2 days</span>
                                        </div>
                                        <div className="flex items-center justify-between text-sm">
                                            <span className="text-slate-600 dark:text-slate-400">Math Assignment</span>
            ...
            <section id="lecturers" className="py-20 lg:py-32 bg-slate-100 dark:bg-slate-900/50">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1 relative">
                            <div className="bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-3xl p-12 space-y-6">
                                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg">
                                    <div className="flex items-center justify-between mb-4">
                                        <span className="text-sm font-medium text-slate-900 dark:text-white">Class Overview</span>
                                ...
                                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg">
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <span className="text-sm font-medium text-slate-900 dark:text-white">Performance Trends</span>
                                    </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-100 dark:bg-slate-900/50 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-16">
                    ...
                    <div className="relative">
                        ...
                        >
                            {[
                                ...
                                <div key={index} className="flex-shrink-0 w-[350px] bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 snap-start">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className={`size-10 rounded-full bg-gradient-to-br ${testimonial.gradient} flex items-center justify-center text-white font-bold text-sm`}>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                        ...
                        <div className="w-full lg:w-1/2 relative order-last lg:order-first">
                            <div className="relative z-10 bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 p-8">
                                {/* Stats Header */}
                                <div className="flex items-center justify-between mb-8">
                                    <div className="space-y-1">
                                        <h3 className="text-lg font-bold text-slate-900 dark:text-white">Platform Growth</h3>
                                        <p className="text-sm text-slate-500 dark:text-slate-400">Weekly Activity</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 border border-slate-200 dark:border-slate-700">
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <span className="text-sm font-medium text-slate-600 dark:text-slate-400">Users</span>
                                        </div>
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <div className="space-y-8">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Save Valuable Time</h3>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Data-Driven Insights</h3>
                                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Seamless Experience</h3>
                                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                ...
                                <li>
                                    <a href="#students" className="text-sm text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                        For Students
                                    </a>
                                </li>
                                <li>
                                    <a href="#lecturers" className="text-sm text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                        For Lecturers
                                    </a>
                                </li>
                                <li>
                            ...
                            <div className="mt-6">
                                ...
                                <div className="flex items-center gap-3">
                                    <a
                                        ...
                                        className="p-2 rounded-lg bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 transition-colors"
                                        aria-label="Twitter"
                                    >
