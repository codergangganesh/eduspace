-- ============================================================
-- COMBINED: Cleanup + Recreate (Run this single file)
-- ============================================================
...
CREATE INDEX idx_feed_posts_class ON class_feed_posts(class_id);
CREATE INDEX idx_feed_posts_author ON class_feed_posts(author_id);
CREATE INDEX idx_feed_posts_pinned ON class_feed_posts(class_id, is_pinned DESC, created_at DESC);
...
CREATE TABLE class_feed_reactions (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX idx_feed_reactions_post ON class_feed_reactions(post_id);
CREATE INDEX idx_feed_reactions_user ON class_feed_reactions(user_id);
...
-- Step 4: Create seen table
CREATE TABLE class_feed_seen (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    post_id UUID NOT NULL REFERENCES class_feed_posts(id) ON DELETE CASCADE,
    user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
CREATE INDEX idx_feed_seen_post ON class_feed_seen(post_id);
...
-- ============================================================
-- DONE! All 3 tables created with fixed RLS policies.
-- ============================================================
